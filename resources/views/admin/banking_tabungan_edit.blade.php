            ...
            <div class="card-body">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body p-20">
                        <form action="/admin/banking_tabungan_update/{{ $transaksis->id_transaksi }}" method="POST">
                            @csrf
                            ...
                            <!-- agar form ini hanya dapat diinput via halaman ini saja , Cross side riger forcary-->
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tabungan_transaksi" name="tabungan_transaksi"
                            ...
                            <div class="mb-3">
                                ...
                                <select id="option1" onchange="updateOption2()" class="form-select" aria-label="Default select example" name="keterangan_transaksi">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="option2" class="form-select" aria-label="Default select example" name="warna_transaksi">
