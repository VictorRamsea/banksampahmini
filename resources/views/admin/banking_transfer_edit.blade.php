            ...
            <div class="card-body">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body p-20">
                        <form action="/admin/banking_transfer_update/{{ $transaksis->id_transaksi }}" method="POST">
                            @csrf
                            ...
                            <!-- agar form ini hanya dapat diinput via halaman ini saja , Cross side riger forcary-->
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="username_transaksi" name="username_transaksi"
                                        value="{{ $transaksis->username_transaksi }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="fullname_transaksi" name="fullname_transaksi"
                                        value="{{ $transaksis->fullname_transaksi }}">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Nominal Transaksi</label>
                                    <input type="text" class="form-control" id="transfer_transaksi" name="transfer_transaksi"
                                        value="{{ $transaksis->transfer_transaksi }}">
                                </div>
                                <div class="mb-3">
