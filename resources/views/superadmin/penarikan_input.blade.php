            ...
            <div class="card-body">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body p-20">
                        <form action="{{ route('penarikan_save') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_penarikan" name="tanggal_penarikan"
                                    value="{{ Session::get('tanggal_penarikan') }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nominal_penarikan" name="nominal_penarikan"
                                    value="{{ Session::get('nominal_penarikan') }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <a href="{{ url('/superadmin/transaksi') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
