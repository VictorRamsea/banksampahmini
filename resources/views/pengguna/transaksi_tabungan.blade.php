                ...
                <div class="card-body">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body p-20">
                            <form action="{{ route('transaksi_tabungan_save') }}" method="POST">
                                <?= csrf_field() ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="username_transaksi"
                                        name="username_transaksi" value="{{ $userall->username }}" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Nama</label>
                                    <input type="text" class="form-control" id="fullname_transaksi"
                                        name="fullname_transaksi" value="{{ $userall->name }}" readonly>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tabungan_transaksi"
                                        name="tabungan_transaksi" value="{{ Session::get('tabungan_transaksi') }}">
                                </div>
